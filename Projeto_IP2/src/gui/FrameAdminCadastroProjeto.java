...
//		}
	...
	public void actionPerformed(ActionEvent e) {
		if (e.getSource().equals(btnLimpar)){
			...
			String nomeEmpresa = txtDescricaoProjeto.getText();
			String cnpj = cmbBxCoordenador.getName();
			String endereco = txtDataInicio.getText();
			String contato = txtHoras.getText();
